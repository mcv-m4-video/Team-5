function Tikhinov_reg_vect_MarkII

dbstop if error

% Input images
Data{1}.im = single(imread('../../Datasets/OpticalFlow_Dataset/im000157_10.png'));
Data{2}.im = single(imread('../../Datasets/OpticalFlow_Dataset/im000157_11.png'));
...
%% Tikhinov regularized and vectorized
[U, V] = Flow1(Data{1}.im, Data{2}.im, size(Data{1}.im));

%% plotting motion vector on image
figure;imshow(Data{1}.im);
hold on;
...
function [U, V] = Flow1(imNew, imPrev, flowRes)
