...
function [fr,macroDat] = FancyFlowPlayer(pathToSave)
...
%
% EXAMPLE
%%% Assume saved data is located in folder "GroundTruthData"
...
hFig = figure('WindowKeyPressFcn',@locKeypress,...
              ...
              'NumberTitle','off','Name',['The FANCY FLOW PLAYER!!  directory: ' pathToDisp]);
if ~isempty(u)
